...
static void vEsp_Gap_Cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SCAN_START_COMPLETE_EVT:
        ESP_LOGI("BLE", "ESP_GAP_BLE_SCAN_START_COMPLETE_EVT");
    ...
    {
        ESP_LOGI("BLE", "ESP_GAP_BLE_SCAN_RESULT_EVT");
        ...
        case ESP_GAP_SEARCH_INQ_CMPL_EVT:
            ESP_LOGI("BLE", "ESP_GAP_SEARCH_INQ_CMPL_EVT");
            esp_ble_gap_stop_scanning();
            break;
        default:
            break;
    ...
    case ESP_GAP_BLE_SCAN_STOP_COMPLETE_EVT:
        ESP_LOGI("BLE", "ESP_GAP_BLE_SCAN_STOP_COMPLETE_EVT");
        ESP_ERROR_CHECK(esp_event_post_to(event_loop_task, TASK_EVENTS, DESTORY_BLE_DISCOVERY_TASK, NULL, 0, portMAX_DELAY));
...
static void vEsp_Gatts_Event_Handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    // if the event is not a register event, then callback.
